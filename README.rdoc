...
After using th gem Term Extraction, I happened to need the score of the different tags I got from the different APIS + I wanted to use Nokogiri for performance concerns.
...
sem.terms
sem.categories
sem.filter  #filters the useful content from an url, retrieves text
